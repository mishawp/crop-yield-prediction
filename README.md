...
![RNNRegressor](resources/images/RNN.jpg)

- MultiCNNGRU

![RNNRegressor](resources/images/MultiCNNGRU.jpg)

- ResNetRegressor

![ResNetRegressor](resources/images/ResNetRegressor.jpg)

[Постановка задачи](#постановка-задачи)

|        | RNNRegressor | MultiCNNGRU | ResNetRegressor (August 15) | ResNetRegressor (Jun 15) |
| ------ | ------------ | ----------- | --------------------------- | ------------------------ |
| $R^2$  | -0.007       | 0.589       | 0.618                       | 17.849                   |
| $RMSE$ | 28.995       | 18.503      | 0.408                       | 22.209                   |
